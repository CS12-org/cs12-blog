...
<div className=" bg-mantle flex items-center justify-between rtl text-right rounded-[10px]">
  <span className="font-Vazirmatn w-[670px] h-[36px] p-[10px] text-subtext-0 text-[12px]">
    در این بخش شما می‌بینید که در هر دوره‌ای که قبول کردید که یاد بگیرید، در چه سطحی هستید و کجای دوره ایستاده‌اید.
  </span>
...
<header className="flex justify-between items-center">
  ...
  <div className="bg-crust flex items-center justify-between px-4 py-2 rounded-tl-[10px] rounded-tr-[10px]">
    <div className="flex gap-2">
      <span className="bg-base text-sapphire text-sm px-3 py-1 rounded-md font-Vazirmatn">برنامه نویسی</span>
      <span className="bg-base text-maroon text-sm px-3 py-1 rounded-md font-Vazirmatn">زبان سی</span>
    </div>
...
>
  ...
  <div className="bg-[#0d0e1a] p-4 text-xs leading-loose text-[#CAD3F5]">
    شما تا <span className="text-teal font-semibold">قسمت ۱۲</span> از دوره برنامه نویسی و بخش زبان سی رو جلو رفتید.<br />
    مباحثی که تا الان باید بلد باشید:<br />
    - متغیر ها و دیتا تایپ ها در زبان سی [خلاصه مطلب]
  </div>
...
<div className="w-[680px] h-[89px] rounded-md overflow-hidden text-white rounded-br-[10px] rounded-bl-[10px]">
  <div className="bg-crust flex items-center justify-between px-4 py-2 rounded-tl-[10px] rounded-tr-[10px]">
    <div className="flex gap-2">
      <span className="bg-base text-sapphire text-sm px-3 py-1 rounded-md font-Vazirmatn">برنامه نویسی</span>
      <span className="bg-base text-maroon text-sm px-3 py-1 rounded-md font-Vazirmatn">بش</span>
    </div>
    <button className=" w-[17px] h-[3px] flex items-center justify-center rounded hover:bg-mantle transition ">
<svg
  xmlns="http://www.w3.org/2000/svg"
...
>
  ...
  <div className="bg-[#0d0e1a] p-4 text-xs leading-loose text-[#CAD3F5] ">
    <span>شما هنوز هیچ یک از قسمت های این دوره رو مشاهده یا مطالعه نکردید.</span>
  </div>
...
<div className="w-[680px] h-[89px] rounded-md overflow-hidden text-white rounded-br-[10px] rounded-bl-[10px]">
  <div className="bg-crust flex items-center justify-between px-4 py-2 rounded-tl-[10px] rounded-tr-[10px]">
    <div className="flex gap-2">
      <span className="bg-base text-sapphire text-sm px-3 py-1 rounded-md font-Vazirmatn">برنامه نویسی</span>
      <span className="bg-base text-maroon text-sm px-3 py-1 rounded-md font-Vazirmatn">سی میک</span>
    </div>
    <button className=" w-[17px] h-[3px] flex items-center justify-center rounded hover:bg-mantle transition ">
<svg
  xmlns="http://www.w3.org/2000/svg"
...
<div className="w-[680px] h-[89px] rounded-md overflow-hidden text-white rounded-br-[10px] rounded-bl-[10px]">
  <div className="bg-crust flex items-center justify-between px-4 py-2 rounded-tl-[10px] rounded-tr-[10px]">
    <div className="flex gap-2">
      <span className="bg-base text-sapphire text-sm px-3 py-1 rounded-md font-Vazirmatn">برنامه نویسی</span>
      <span className="bg-base text-maroon text-sm px-3 py-1 rounded-md font-Vazirmatn">گنو میک</span>
    </div>
    <button className=" w-[17px] h-[3px] flex items-center justify-center rounded hover:bg-mantle transition ">
<svg
  xmlns="http://www.w3.org/2000/svg"
...
<div className="w-[680px] h-[89px] rounded-md overflow-hidden text-white rounded-br-[10px] rounded-bl-[10px]">
  <div className="bg-crust flex items-center justify-between px-4 py-2 rounded-tl-[10px] rounded-tr-[10px]">
    <div className="flex gap-2">
      <span className="bg-base text-sapphire text-sm px-3 py-1 rounded-md font-Vazirmatn">برنامه نویسی</span>
      <span className="bg-base text-maroon text-sm px-3 py-1 rounded-md font-Vazirmatn">دفتلچه گیت</span>
    </div>
    <button className=" w-[17px] h-[3px] flex items-center justify-center rounded hover:bg-mantle transition ">
<svg
  xmlns="http://www.w3.org/2000/svg"
...
<svg
  ...
  viewBox="0 0 28 28"
  fill="currentColor"
  className="w-15 h-5 text-green-400"
>
