  ...
  return (
    <div className="flex gap-x-5 w-full ">
      ...
      <main className="flex flex-col gap-4 w-full text-subtext-1">
        ...
        <div className="flex items-center gap-x-2.5 bg-crust p-2 rounded-xl">
          <div className="bg-mantle p-2 w-full rounded-md bg-mantle h-9 text-xs">
            شما یک کاربر عادی هستید برای تبدیل شدن به منتور درخواست بدید.{" "}
          </div>
        </div>
        <MyCheckboxGroup>
          <MyCheckbox value="sss">some test</MyCheckbox>
          <MyCheckbox value="sss1">some test</MyCheckbox>
          <MyCheckbox value="sss2">some test</MyCheckbox>
          <MyCheckbox value="sss3">some test</MyCheckbox>
        </MyCheckboxGroup>
      </main>
    </div>
  );
