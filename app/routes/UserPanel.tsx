  ...
  return (
    <div className="flex gap-x-5 w-full items-start">
      ...
      <main className="flex flex-col gap-2.5 w-full text-subtext-1">
        ...
        <div className="bg-crust  rounded-xl flex flex-col w-full  ">
          <div className="grid grid-cols-6 grid-rows-1 content-center items-center ">
            ...
            <div className="col-start-3 col-end-7 flex flex-col gap-y-2 m-2.5">
     ...
     <SettingCheckboxGroup className="bg-crust rounded-xl p-2 w-full flex flex-col gap-y-2.5">
