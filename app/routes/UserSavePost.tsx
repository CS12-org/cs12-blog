...
<header className="flex justify-between items-center">
  ...
  <div className="text-sm text-right text-white">عنوان پستی که ذخیره شده</div>
  <div className="flex items-center gap-3">
    {/* Timer Icon (قبل) */}
    <div className="bg-gray-800 p-2 rounded-full">
      <div className="w-6 h-6 relative text-indigo-300">
        <svg className="absolute inset-0 w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2"
          viewBox="0 0 24 24">
          <circle cx="12" cy="12" r="10" />
          <path d="M12 6v6l4 2" />
        </svg>
        <span className="absolute text-xs inset-0 flex items-center justify-center font-bold">10</span>
      </div>
    </div>
    {/* Bookmark Icon (بعد) */}
